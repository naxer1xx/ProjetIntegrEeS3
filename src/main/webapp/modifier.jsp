...
<body>
	...
	<div class="resize shadow-lg p-3 mb-5 bg-white rounded">
		<form class="row g-3" method="POST" action="hello?mod=OK">
			...
			<div class="col-md-12">
				...
				<label for="inputEmail4" class="form-label">Id</label> <input
					...
					value="${clientM.getId()}" id="inputEmail4" hidden >
			</div>
			...
			<div class="col-md-6">
				...
				<label for="inputEmail4" class="form-label">Nom</label> <input
					...
					value="${clientM.getNom()}" id="inputEmail4">
			</div>
			<div class="col-md-6">
				<label for="inputPassword4" class="form-label">Prenom</label> <input
					type="text" name="prenom" class="form-control"
					value="${clientM.getPrenom()}" id="inputPassword4">
			</div>
			<div class="col-12">
				<label for="inputAddress" class="form-label">Email</label> <input
					type="email" class="form-control" name="email"
					value="${clientM.getEmail()}" id="inputAddress" placeholder="">
			</div>
			<div class="col-12">
				<label for="inputAddress2" class="form-label">Ville</label> <input
					type="text" class="form-control" name="ville"
					value="${clientM.getVille()}" id="inputAddress2" placeholder="">
			</div>
			<div class="col-12">
				<label for="inputCity" class="form-label">Adresse</label> <input
					type="text" class="form-control" name="adresse"
					value="${clientM.getAdresse()}" id="inputCity">
			</div>
